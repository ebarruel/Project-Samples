...
architecture Behavioral of RAT_wrapper is
   ...
   CONSTANT BUTTON_ID   : STD_LOGIC_VECTOR (7 downto 0) := X"42"; -- added for btn input
   CONSTANT VGA_READ_ID : STD_LOGIC_VECTOR (7 downto 0) := X"93";
   CONSTANT RAND_IN_ID  : STD_LOGIC_VECTOR (7 downto 0) := X"94"; -- added for rand int
   -------------------------------------------------------------------------------
...
begin
   ...
   begin
      ...
      elsif s_port_id = RAND_IN_ID then         -- added for random int
        s_input_port <= rand_in;
   	  else
    	s_input_port <= x"00";
      end if;
   end process inputs;
