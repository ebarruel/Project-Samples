...
wall_1:
		 CALL draw_vertical_line ; make first wall
		 SUB r9, 0x01
		 MOV r7, 0x00
		 ADD r8, 0x01
		 CMP r8, 0x28
		...
		CALL   thic_pause
		 ...
		 MOV    r6, BG_COLOR ; del right side first wall
		 SUB r8, 0x01
		...
		CALL   thic_pause
		 ...
		 MOV    r6, WALL_COLOR ; make new front of first wall
		 SUB r8, 0x04
		 CALL   draw_vertical_line
		 SUB r9, 0x01
		 MOV r7, 0x00
		...
		CALL thic_pause
		 ...
		 MOV    r6, WALL_COLOR ; make second wall
		 CALL get_wall_height
		 MOV r16, 0x00
wall_two:		 
		 ADD r8, 0x04
		 ...
		 ;MOV    r6, WALL_COLOR ; make third wall
		 ;CALL get_wall_height
		 ;MOV r16, 0x00

		 ;MOV    r6, BG_COLOR ; del right side second wall
		 ;SUB r8, 0x01
		 ;LD r9, 0x30 ; height of wall 1
		 ;CALL   draw_vertical_line
		 ;SUB r9, 0x01
